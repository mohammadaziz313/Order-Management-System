...
<div id="content-header">
    <div id="breadcrumb"> <a href=@php echo url('/dashboard'); @endphp title="Dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a><a href=@php echo url('/inventory-info'); @endphp class="current">Inventory</a></div>
  </div>
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=@php echo url('/inventory-info/add-new-inventory'); @endphp> <i class="icon-dashboard"></i> Add New Item </a> </li>
        <!--
