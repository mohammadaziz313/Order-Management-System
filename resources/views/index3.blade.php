...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li> <a href="charts.html"><i class="icon icon-signal"></i> <span>Purchase Order</span></a> </li>
    <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>Sales Order</span></a> </li>
    <li><a href=@php echo url('tables'); @endphp><i class="icon icon-th"></i> <span>Inventory</span></a></li>
    <li><a href="grid.html"><i class="icon icon-fullscreen"></i> <span>Listing</span></a></li>
