...
<div id="content-header">
  <div id="breadcrumb"> <a href=@php echo url('/dashboard'); @endphp title="Dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a><a href=@php echo url('/inventory'); @endphp class="tip-bottom">Inventory</a><a href=@php echo url('/inventory/add-new-inventory'); @endphp class="current">Add New Supplier</a></div>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action=@php echo url('/inventory/add-new-supplier') @endphp method="post" class="form-horizontal">
