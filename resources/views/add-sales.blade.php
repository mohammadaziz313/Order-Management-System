...
<div id="content-header">
  <div id="breadcrumb"> <a href=@php echo url('/dashboard'); @endphp title="Dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a><a href=@php echo url('/sales'); @endphp class="tip-bottom">Sales</a><a href=@php echo url('/sales/add-sales'); @endphp class="current">New Sales Order</a></div>
  ...
  <div class="row-fluid">
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action=@php echo url('/sales/add-sales') @endphp method="post" class="form-horizontal">
    ...
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=@php echo url('/sales/add-salesContinue'); @endphp> <i class=""></i><b>Continue</b></a> </li>
        <!--
