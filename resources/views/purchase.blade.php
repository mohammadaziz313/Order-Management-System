...
<div id="search">
<form action=@php echo url('/purchase/searchProduct'); @endphp method="post">
  <input name="id" type="text" placeholder="Search Here"/>
  <a href=@php echo url('/purchase/search'); @endphp><button type="submit" class="tip-bottom" title="Search"><i class="icon-search icon-white"></i></button></a>
</div>
...
<div id="content-header">
    <div id="breadcrumb"> <a href=@php echo url('/dashboard'); @endphp title="Dashboard" class="tip-bottom"><i class="icon-home"></i> Dashboard</a><a href=@php echo url('/purchase'); @endphp class="current">Purchase Order</a></div>
  </div>
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href=@php echo url('/purchase/add-new-product'); @endphp> <i class="icon-dashboard"></i> Add New Item </a> </li>
        <!--
